...
namespace KhanhLinh
{
    public partial class AddRouteTrackingScreen : Form
    {
        public AddRouteTrackingScreen()
        {
            InitializeComponent();
        }

        private void AddRouteTrackingScreen_Load(object sender, EventArgs e)
        {
            // TODO: This line of code loads data into the 'finalDataSet.Route' table. You can move, or remove it, as needed.
            this.routeTableAdapter.Fill(this.finalDataSet.Route);
            // TODO: This line of code loads data into the 'finalDataSet.Car' table. You can move, or remove it, as needed.
            this.carTableAdapter.Fill(this.finalDataSet.Car);

        }

        private void listRouteTrackingBtn_Click(object sender, EventArgs e)
        {
