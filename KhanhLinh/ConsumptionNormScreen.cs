...
namespace KhanhLinh
{
    public partial class ConsumptionNormScreen : Form
    {
        public ConsumptionNormScreen()
        {
            InitializeComponent();
        }

        private void ConsumptionNormScreen_Load(object sender, EventArgs e)
        {
            // TODO: This line of code loads data into the 'khanhLinhDataSet.vConsumptionNorm' table. You can move, or remove it, as needed.
            this.vConsumptionNormTableAdapter.Fill(this.khanhLinhDataSet.vConsumptionNorm);
        ...
        private void thêmToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            AddConsumptionNormScreen addConsumptionNormScreen = new AddConsumptionNormScreen();
            addConsumptionNormScreen.Show();
        ...
        private void metroGrid1_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (e.RowIndex >= 0)
            {
                normId = metroGrid1.Rows[e.RowIndex].Cells["idDataGridViewTextBoxColumn"].Value?.ToString();
            }
        ...
        private void cậpNhậtToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            {
                UpdateConsumptionNormScreen updateConsumptionNormScreen = new UpdateConsumptionNormScreen();
                updateConsumptionNormScreen.Show();
            }
        }
    }
}
