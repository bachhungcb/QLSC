...
namespace KhanhLinh
{
    public partial class AddItemWarehouse : Form
    {
       private  string connectionString = ConfigurationManager.ConnectionStrings["KhanhLinh.Properties.Settings.KhanhLinhConnectionString"].ToString();
        ...
        {
            string ItemCode = itemCode.Text.Trim();
            ...
            using (SqlConnection connect = new SqlConnection(connectionString))
            {
                try
                {
                    ...
                    SqlCommand cmd = new SqlCommand("INSERT INTO Warehouse(Code,Name) VALUES (@ItemCode, @ItemName)", connect);
