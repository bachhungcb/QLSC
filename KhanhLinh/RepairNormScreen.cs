...
namespace KhanhLinh
{
    public partial class RepairNormScreen : Form
    {
        public RepairNormScreen()
        {
            InitializeComponent();
        }

        private void RepairNormScreen_Load(object sender, EventArgs e)
        {
            // TODO: This line of code loads data into the 'khanhLinhDataSet.vRepairNorm' table. You can move, or remove it, as needed.
            this.vRepairNormTableAdapter.Fill(this.khanhLinhDataSet.vRepairNorm);
