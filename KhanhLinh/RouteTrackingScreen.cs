...
namespace KhanhLinh
{
    public partial class RouteTrackingScreen : Form
    {
        public RouteTrackingScreen()
        {
            InitializeComponent();
        }

        private void RouteTrackingScreen_Load(object sender, EventArgs e)
        {
            // TODO: This line of code loads data into the 'finalDataSet.vRouteTracking' table. You can move, or remove it, as needed.
            this.vRouteTrackingTableAdapter.Fill(this.finalDataSet.vRouteTracking);

        }

        private void addRouteTrackingBtn_Click(object sender, EventArgs e)
        {
            AddRouteTrackingScreen addRouteTrackingScreen = new AddRouteTrackingScreen();
            this.Hide();
            addRouteTrackingScreen.Show();
        }
